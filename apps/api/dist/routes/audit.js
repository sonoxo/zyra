...
export async function logAudit(action, entityType, entityId, userId, orgId, details, ipAddress, userAgent) {
    try {
...
export default async function auditRoutes(fastify) {
    ...
    fastify.get('/', async (req, reply) => {
        const { entityType, action, userId, orgId, limit = '50' } = req.query;
